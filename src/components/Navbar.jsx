          ...
          <div className='flex items-center justify-between h-16'>
            ...
            <div className='-mr-2 flex md:hidden'>
              <button
                ...
                type='button'
                className='bg-slate-600 inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-700 focus:ring-teal-500'
